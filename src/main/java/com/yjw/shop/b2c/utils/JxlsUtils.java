package com.yjw.shop.b2c.utils;
...
public class JxlsUtils {
    ...
    private static final String TEMPLATE_PATH="static/execltemplate";
    ...
    //获取jxls模版文件
    public static File getTemplate(String name) throws UnsupportedEncodingException {
